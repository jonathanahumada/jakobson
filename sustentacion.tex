...
\label{sec:org3238735}

\begin{frame}[label={sec:org2ba9d3b}]{¿Qué es \emph{literariedad}?}
...
\begin{frame}[label={sec:org1df12ee}]{Antecedentes: Los clásicos}
...
\begin{frame}[label={sec:org1160eec}]{Antecedentes: la linguística estructural}
...
\begin{frame}[label={sec:org1f58e33}]{Específicos}
\begin{enumerate}
...
\begin{frame}[label={sec:orgf9ee5dd}]{Alcance}
\begin{enumerate}
...
\label{sec:org32356d6}

\begin{frame}[label={sec:orge2080bc}]{Introducción a metáfora y metonimia}
\begin{columns}
\begin{column}{0.48\columnwidth}
 \begin{figure}
...
\begin{frame}[label={sec:org157ae08}]{Usuarios}
  \begin{figure}
...
\begin{frame}[label={sec:org10a9dbf}]{Resumen}
\begin{figure}
...
\begin{frame}[label={sec:org18cf9f0}]{Wordnet}
\begin{columns}
\begin{column}{0.48\columnwidth}
...
\begin{frame}[label={sec:orgecec2ea}]{Modelamiento}
\begin{columns}
\begin{column}{0.48\columnwidth}
\tiny
...
\begin{frame}[label={sec:orgbe9c8a2}]{Diseño experimental}
...
\begin{frame}[label={sec:org2e0166e}]{Resultados por metacategorías}
\begin{columns}
\begin{column}{0.48\columnwidth}
\begin{figure}[H]
\centering
