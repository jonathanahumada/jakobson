...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org9f1237f}]{Resumen}
\begin{figure}
...
\begin{frame}[label={sec:orga810ac8}]{Modelamiento}
\begin{columns}
\begin{column}{0.48\columnwidth}
\tiny
...
\begin{frame}[label={sec:orgda63001}]{Diseño experimental}
...
\begin{frame}[label={sec:orgdb3f006}]{Resultados por metacategorías}
\begin{columns}
\begin{column}{0.48\columnwidth}
\begin{figure}[H]
\centering
