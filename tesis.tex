...
\caption{\label{fig:org92fad0d}Distinción inicial entre sincronía y diacronía según Saussure, tomado de \cite{alonso1945curso}}
\end{figure}
...
\ref{fig:org7a28e89}). Sin embargo, cuando se estudia la \emph{literariedad},
...
\caption{\label{fig:org7a28e89}Factores de comunicación de Roman Jakobson \cite{jakobson1981linguistica}}
\end{figure}
...
\ref{fig:orgb7c6aac}, el eje AB se considera el \emph{eje de simultaneidades},
...
\caption{\label{fig:orgb7c6aac}Ejemplo de estructuras secuenciales en el pensamiento de Saussure. Aquí se describe prototípicamente la selección y combinación de Roman Jakobson. Tomado de \cite{alonso1945curso}}
\end{figure}

\subsection{Justificacón}
\label{sec:orgf2cbc4b}
...
están sintetizadas en la figura \ref{fig:org366ce74}.
...
\caption{\label{fig:org366ce74}Resumen de las fuentes de datos utilizadas para cada concepto}
\end{figure}
...
Para la producción de estos gráficos, se tomaron los resultados presentados en \ref{sec:org6d12565}, y
