...
\label{sec:orgf6a0e4a}
\subsection{Introducción}
\label{sec:orge680039}
...
\label{sec:orgda39114}

\subsection{Literariedad}
\label{sec:orgdb4c47d}
...
repeticón de sonidos similares: [ay layk ayk]. La similaridad, no
...
\label{sec:org1c576c9}
El diseño metodológico seguirá a grandes rasgos los pasos de la metodología CRISP-DM,
que se considera un estándar de facto para proyectos de minería de datos. Esta metodología
ayudará organizar el proceso de mi investigación, que vá desde el accesso a los corpus
(los datos disponibles) hasta el despliegue (la visualización de los resultados).
\subsection{Entendimiento del negocio}
\label{sec:org97bb413}

El resultado tangible del modelo de literariedad son dos métricas
cuantitativas: \emph{metáfora} y \emph{metonímia}.  Estas métricas juntas
constituiran una representación 'objetiva' del concepto
...
\label{sec:orgfe526ca}
\subsubsection{Por qué utilizo el Brown Corpus}
\label{sec:org927f5b3}
\subsection{Preparación de los datos}
\label{sec:orgdfd50e4}
...
\label{sec:org0f5b906}
\begin{enumerate}
\item Presentacion de las ecuaciones
\label{sec:orgc954ae9}
...
\label{sec:org4d3ba0c}
\item Matriz semántica
\label{sec:org5b0d859}


\item Matriz de uso
\label{sec:org802cd25}
