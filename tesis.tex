...
\caption{\label{fig:org5d28f95}Distinción inicial entre sincronía y diacronía según Saussure, tomado de \cite{alonso1945curso}}
\end{figure}
...
\ref{fig:org1279cdc}). Sin embargo, cuando se estudia la \emph{literariedad},
...
\caption{\label{fig:org1279cdc}Factores de comunicación de Roman Jakobson \cite{jakobson1981linguistica}}
\end{figure}
...
\ref{fig:orgc11a575}, el eje AB se considera el \emph{eje de simultaneidades},
...
\caption{\label{fig:orgc11a575}Ejemplo de estructuras secuenciales en el pensamiento de Saussure. Aquí se describe prototípicamente la selección y combinación de Roman Jakobson. Tomado de \cite{alonso1945curso}}
\end{figure}

\subsection{Justificacón}
\label{sec:orgc12835b}
...
\ref{fig:org2764692}). Además, el formato del corpus varía
...
\caption{\label{fig:org2764692}Diferentes estructuras de corpus}
\end{figure}

\subsection{Analítica de datos}
\label{sec:org404cb3c}
...
Para la producción de estos gráficos, se tomaron los resultados presentados en \ref{sec:org4e4b762}, y
