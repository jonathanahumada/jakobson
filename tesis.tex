...
\label{sec:orgc3f77d8}
\subsection{Introducción}
\label{sec:orga0dd19e}
...
\label{sec:org8ab45e5}

\subsection{Literariedad}
\label{sec:orgff6c6cf}
...
\caption{\label{fig:orgb23cbc7}Relación de linguística computacional con otras areas tomado de \cite{gelbukh2004}}
\end{figure}


\subsection{NLP}
\label{sec:orga544923}
...
\ref{fig:orgec58469}). Además, el formato del corpus varía
...
\caption{\label{fig:orgec58469}Diferentes estructuras de corpus}
\end{figure}

\subsection{Analítica de datos}
\label{sec:org61a3186}
...
Para la producción de estos gráficos, se tomaron los resultados presentados en \ref{sec:orgec46c67}, y
...
\label{sec:orgbc03989}

\subsubsection{El índice metafórico}
\label{sec:orgb019920}
