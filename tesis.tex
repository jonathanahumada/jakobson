...
\label{sec:org7c28701}
\subsection{Introducción}
\label{sec:orgb9f9e2f}
...
\label{sec:org334ed3a}

\subsection{Literariedad}
\label{sec:org3f28a66}
...
heterogéneo(ver \ref{fig:org2a8851d}).
Este trabajo se incribe concretamente dentro del procesamiento
del lenguaje natural \ref{sec:org648c7ee}, y tiene un fuerte componente de
lingüística general .

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./assets/mapa_linguistica.png}
\caption{\label{fig:org2a8851d}Relación de linguística computacional con otras areas tomado de \cite{gelbuhk2004}}
\end{figure}


\subsection{NLP}
\label{sec:org648c7ee}
...
en la sección  \ref{sec:org172e517}, utilizando
n-gramas de nivel 2 o \textbf{bigramas}.


\subsubsection{Tokenización}
\label{sec:orgafc7b08}
...
pasos descritos en la sección \ref{sec:org172e517}. Sin embargo,
...
\ref{fig:org8f46d3a}). Además, el formato del corpus varía
...
\caption{\label{fig:org8f46d3a}Diferentes estructuras de corpus}
\end{figure}

\subsection{Analítica de datos}
\label{sec:orge31bde7}
...
\label{sec:orgebe847a}
En las secciones \ref{sec:org1fdc644}, \ref{sec:org5795bb9} y
\ref{sec:org96f6537} se presentarán los resultados del experimento
...
\ref{sec:orgbdc4dde}. En cada tabla se presentan el índice
...
consultar las secciones \ref{sec:org5795bb9} y \ref{sec:org96f6537}.
\begin{center}
...
\label{sec:org5795bb9}
En esta sección se presentan los gráficos para cada uno de los corpus objetivos
definidos en \ref{sec:orgbdc4dde}. Cada cúmulo de gráficos consta de 2 filas.
...
Para la producción de estos gráficos, se tomaron los resultados presentados en \ref{sec:org1fdc644}, y
...
La visualización del comportamiento de los indicadores será necesaria para las Conclusiones (\ref{sec:orgc5daef3}).
...
\label{sec:org0deba44}
Según lo contempla el proceso de analítica de datos (ver sección \ref{sec:orge31bde7}),
...
Sin embargo, teniendo en cuenta los hipótesis planteadas en la sección \ref{sec:org39a91fe},
...
\label{sec:org2183df8}

\subsubsection{El índice metafórico}
\label{sec:orgc2da0ce}
