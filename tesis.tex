...
\ref{fig:org4797b0f}, el eje AB se considera el \emph{eje de simultaneidades},
...
\caption{\label{fig:org4797b0f}Ejemplo de estructuras secuenciales en el pensamiento de Saussure. Aquí se describe prototípicamente la selección y combinación de Roman Jakobson. Tomado de \cite{alonso1945curso}}
\end{figure}

\subsection{Justificacón}
\label{sec:orge448ac3}
...
\ref{fig:orgc655c77}). Además, el formato del corpus varía
...
\caption{\label{fig:orgc655c77}Diferentes estructuras de corpus}
\end{figure}

\subsection{Analítica de datos}
\label{sec:org71c1ff7}
...
Para la producción de estos gráficos, se tomaron los resultados presentados en \ref{sec:org0358b93}, y
